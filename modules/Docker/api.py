...
from .lab_checker.core import LabChecker
from .lab_checker.types import LabType
from .lab_checker.config import Config, load_config as load_config_func
...
def check_lab_dir(project_dir: str, lab_type: str, config: Optional[Config] = None, silent_mode: bool = False) -> Dict:
    ...
    # Нормализуем тип лабораторной для поиска в конфиге и создания Enum
